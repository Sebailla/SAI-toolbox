...
|-----------------|---------------|-----------|-----------|
| `init-project/init-project.sh` | ~150 | 3 (main, slugify, source loop) | Punto de entrada |
...
| `init-project/lib/selectors.sh` | ~350 | 9 | Configuración interactiva de proyecto |
| `init-project/lib/builders.sh` | ~600 | 5 | Scaffolding de proyectos |
| `init-project/lib/setup.sh` | ~750 | 16 | Configuración post-scaffold |
